  ...
  const products = [
    {
      ...
      price: 6.99,
      image: require('../assets/membership/one.png'),
    ...
    },
    {
      ...
      price: 54.99,
      image: require('../assets/membership/standard.png'),
      duration: '1 Month',
      facilities: 'Access to all gym facilities'
    },
    {
      ...
      price: 135.99,
      image: require('../assets/membership/elite.png'),
      duration: '3 Months',
      facilities: 'Access to all gym facilities'
    },
    {
      ...
      price: 516.99,
      image: require('../assets/membership/ultimate.png'),
      duration: '12 Months',
      facilities: 'Access to all gym facilities'
    },
  ];
    ...
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      <View style={[styles.container, isDarkMode ? styles.darkContainer : null]}>
        <View style={styles.imageContainer}>
          <Image
            source={require('../assets/membership/membership.webp')}
            style={styles.image}
            resizeMode="cover"
          />
        ...
        {products.map(product => (
          <View key={product.id} style={[styles.planContainer, isDarkMode ? styles.darkPlanContainer : null]}>
            ...
            <View style={styles.benefitContainer}>
              <Image
                source={require('../assets/membership/checked.png')}
