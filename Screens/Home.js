...
export default function Home() {
  ...
  const images = [
    {
      url: require('../assets/Sales/smartwatch.png'),
      component: (
        <TouchableImage
          source={require('../assets/Sales/smartwatch.png')}
      ...
      <View style={[styles.container, isDarkMode && styles.darkContainer]}>
        <View style={[styles.blueContainer, isDarkMode && styles.darkBlueContainer]}>
          <View style={styles.searchContainer}>
            ...
            <TouchableOpacity onPress={() => console.log("Button pressed")} style={styles.iconContainer}>
              <Image source={require('../assets/reorder-horizontal.png')} style={styles.iconImage} />
            </TouchableOpacity>
          </View>
        </View>
        ...
        <View style={styles.membershipContainer}>
          <TouchableOpacity onPress={() => navigation.navigate('Membership')}>
            <Image source={require('../assets/membership/try.png')} style={styles.membershipImage} />
          </TouchableOpacity>
        </View>
        ...
        <View style={[styles.categoriesContainer, isDarkMode && styles.darkCategoriesContainer]}>
          ...
          <ScrollView horizontal={true} showsHorizontalScrollIndicator={true}>
            <View style={styles.categoryItemsContainer}>
              {[
                { name: 'Machines', image: require('../assets/Categories/dumbell.png') },
                { name: 'Supplements', image: require('../assets/Categories/supplements.png') },
                { name: 'Shirts', image: require('../assets/Categories/shirt.png') },
                { name: 'Smartwatches', image: require('../assets/Categories/smartwatch.png') },
                { name: 'Accessories', image: require('../assets/Categories/gloves.png') },
              ].map((category, index) => (
                <TouchableOpacity
                  key={index}
